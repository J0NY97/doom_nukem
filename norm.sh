...
norminette game/srcs/Init | grep Error
norminette game/srcs/Math | grep Error
norminette game/srcs/Free | grep Error
norminette game/srcs/Draw | grep Error
norminette game/srcs/Events | grep Error
norminette game/srcs/BuyMenu | grep Error
norminette game/srcs/ParseMap | grep Error
norminette game/srcs/EntityCoords | grep Error
norminette game/srcs/CollisionDetection | grep Error
